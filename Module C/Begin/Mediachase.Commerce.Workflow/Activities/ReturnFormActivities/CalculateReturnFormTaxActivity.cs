...
namespace Mediachase.Commerce.Workflow.Activities.ReturnForm
{
	public class CalculateReturnFormTaxActivity : ReturnFormBaseActivity
	{
		...
		private decimal CalculateLineItemSaleTaxes(LineItem lineItem, string shipmentAddressId)
		{
			...
			CatalogEntryDto entryDto = CatalogContext.Current.GetCatalogEntryDto(lineItem.Code, new CatalogEntryResponseGroup(CatalogEntryResponseGroup.ResponseGroup.Variations));
